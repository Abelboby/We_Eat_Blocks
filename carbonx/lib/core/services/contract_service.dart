...
class ContractService {
  ...
  ContractService()
      : _client = Web3Client(_rpcUrl, http.Client()),
        _contract = DeployedContract(
          ContractAbi.fromJson(_contractAbi, 'CarbonXContract'),
  ...
  Future<String> sellTokens({
    ...
    try {
      ...
      final function = _contract.function('sellTokens');
      ...
      debugPrint('Successfully sent sell tokens transaction: $result');
      return result;
    } catch (e) {
  ...
  Future<BigInt> getTokenBalance(String address) async {
    try {
      final function = _contract.function('getTokenBalance');
      ...
      debugPrint('Token balance for $address: ${result[0]}');
  ...
  // Get citizen token balance for an address
  Future<BigInt> getCitizenTokenBalance(String address) async {
    try {
      final function = _contract.function('getCitizenTokenBalance');
      final params = [EthereumAddress.fromHex(address)];
      ...
      debugPrint('Citizen token balance for $address: ${result[0]}');
      return result[0] as BigInt;
    } catch (e) {
      debugPrint('Error getting citizen token balance: $e');
      throw Exception('Failed to get citizen token balance: $e');
    }
  }

  // Get token sell price
  Future<BigInt> getTokenSellPrice() async {
    try {
      final function = _contract.function('tokenSellPrice');
      ...
      debugPrint('Token sell price: ${result[0]}');
      return result[0] as BigInt;
    } catch (e) {
      debugPrint('Error getting token sell price: $e');
      throw Exception('Failed to get token sell price: $e');
    }
  }

  // Get contract ETH balance
  Future<EtherAmount> getContractBalance() async {
    try {
      final result = await _client.getBalance(
        EthereumAddress.fromHex(_contractAddress),
      );

      debugPrint('Contract balance: $result');
      return result;
    } catch (e) {
      debugPrint('Error getting contract balance: $e');
      throw Exception('Failed to get contract balance: $e');
    }
  }
